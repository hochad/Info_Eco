...
Dieses automatische Zählgerät dient zur Erfassung von Outdooraktivitäten. Diese Aktion ist Teil eines Forschungsprojekts an der Zürcher Hochschule für Angewandte Wissenschaften (ZHAW) und des Kantons Schwyz (Wildhüter Matthias Oechslin) in Zusammenarbeit mit der Waldkorporation Wollerau (Betriebsförster Pirmin Schuler). Das Ziel dieses Projekts ist die Förderung eines naturorientierten Outdoorsports.

## Datenschutz {-}

Dieses Zählgerät erfasst keine Personendaten. Der Zugang zu den Geräten ist mit Code und Schloss gesichert und die Daten werden nach der Bearbeitung gelöscht.
